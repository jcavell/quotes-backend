...
insert into product(id, product_id, name, cost, currency_code, data) values(1, 550517407, 'product1', 1.123, 'USD', '{"foo" : "bar"}');
insert into product(id, product_id, name, cost, currency_code, data) values(2, 550544575, 'product2', 0.12, 'USD', '{"foo" : "bar"}');
insert into product(id, product_id, name, cost, currency_code, data) values(3, 550517110, 'product3', 2.123, 'USD', '{"foo" : "bar"}');
insert into product(id, product_id, name, cost, currency_code, data) values(4, 550517110, 'product3', 2.523, 'USD', '{"foo" : "bar"}');
